...
const Navbar = () => {
  ...
  <div className="navbar-end gap-3">
    <Link to={"/login"}><a className="btn bg-[#FFA500] text-white font-semibold">Login</a></Link>
    <Link to={'/signup'}><a className="btn bg-[#FFA500] text-white font-semibold">Sign Up</a></Link>
  </div>
</div>
    );
};
