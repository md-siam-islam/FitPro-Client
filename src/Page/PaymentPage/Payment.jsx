...
const Payment = () => {
  ...
  return (
    ...
    <div className="flex  justify-center gap-5 my-20 bg-white shadow-xl py-5 px-6 border-2 ">
      <div className="w-1/2 bg-gray-300 px-7 py-5 flex flex-col  justify-center rounded-xl ">
